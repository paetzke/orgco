You can make words **bold**, *italic*, underlined and ``code``, and, if you must, '+strike-through+`. Text in the code and verbatim string is not processed for Org mode specific syntax, it is exported verbatim.
